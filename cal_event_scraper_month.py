...
d = feedparser.parse('http://events.berkeley.edu/index.php/rss/sn/pubaff/type/month.html?recur=yes')
fpath = 'monthevent' # Name of the DB and CSV File
...
for e in d.entries:
    ...
    date = link_split[1]
    c.execute("INSERT INTO today VALUES (?,?,?,?)", (e.title, date, e.link,e.description,))
